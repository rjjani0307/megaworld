					...
					<div class="row gutters">
						<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
							...
							<div class="table-container">
								<div class="t-header">Registered Users</div>
										...
										<?php
						                  ...
						                  ?>
											<tr>
											  ...
											  <td><?php echo $result['org'];?></td>
											  <td><?php echo $result['o_email'];?></td>
											  <td><?php echo $result['o_number'];?></td>
											  <td><img src="documents/<?php echo $result['pan_photo'];?>" class="flag-img"></td>
											  <td><?php echo $result['pan'];?></td>
											  <td><img src="documents/<?php echo $result['gst_photo'];?>" class="flag-img"></td>
											  <td><?php echo $result['gst'];?></td>
											  <td><img src="documents/<?php echo $result['identity'];?>" class="flag-img"></td>
